...
public class BrowserBot{
	...
	public static final int WAIT_TIME_LONGDURATION = 45;
	public static final int WAIT_FOR_LONGTIME = 400;
	...
	public void clearInPutField(String elementName, String locatorStrategy) throws Exception {
		waitForElementIsVisible(elementName, locatorStrategy);
		getElement(elementName, locatorStrategy).clear();
	}
...
/*		StackTraceElement[] stacktrace = Thread.currentThread().getStackTrace();
		...
		String method_Name = e.toString();
		 String bal = method_Name.split("\\.")[3];
		test.log(LogStatus.INFO, "Sucessfully Clicked on "+bal);*/		
	}
	...
	/*public void typeRandomNumbers(String elementName, String locatorStrategy, String keys, int numberOfRandomNumbers) throws Exception{
		waitForElementIsVisible(elementName, locatorStrategy);
		getElement(elementName, locatorStrategy).clear();
		getElement(elementName, locatorStrategy).sendKeys(keys+RandomStringUtils.randomNumeric(numberOfRandomNumbers));
	}*/
	...
	public void enableDataField(String id) throws Exception {
		...
		((JavascriptExecutor) driver)
				.executeScript("document.getElementById('" + id + "').removeAttribute('disabled')");
	}
	...
	public void uploadFilesUsingAutoIT(String filepath) throws Exception {
	...
	public WebElement waitForAttributeValue(String elementName, String locatorStrategy, String attribute, String value)
			throws Exception {
		WebElement element = getElement(elementName, locatorStrategy);
		WebDriverWait wait = new WebDriverWait(driver, WAIT_TIME);
	...
	public static void waitForTextToBePresent(String elementName, String locatorStrategy, String strText) {
		try {
			WebDriverWait wait = new WebDriverWait(driver, WAIT_TIME);
			wait.until(ExpectedConditions.textToBePresentInElementLocated(getWebDriverBy(elementName, locatorStrategy),
					strText));
		} catch (WebDriverException we) {
			System.out.println(we.toString());
		} catch (Exception e) {
	...
	public void waitForAllElementVisible(String elementName, String locatorStrategy) {
		try {
			new WebDriverWait(driver, WAIT_TIME_LONGDURATION).until(
					ExpectedConditions.visibilityOfAllElementsLocatedBy(getWebDriverBy(elementName, locatorStrategy)));
		} catch (WebDriverException we) {
			System.out.println(we.toString());
		} catch (Exception e) {
			System.out.println(e.toString());
	...
	public void waitForElementAppearanceLongTime(String elementName, String locatorStrategy) throws Exception {
		new WebDriverWait(driver, WAIT_TIME_LONGDURATION)
				.until(ExpectedConditions.presenceOfElementLocated(getWebDriverBy(elementName, locatorStrategy)));
	}
	...
	public void verifyText(String elementName, String locatorStrategy, String strValue, String errorMessage)
			throws Exception {
	...
	public void verifyTextIsNotPresent(String elementName, String locatorStrategy, String errorMessage)
			throws Exception {
		assertFalse(isElementPresent(elementName, locatorStrategy), errorMessage);
	}

	public void verifyInputValue(String elementName, String locatorStrategy, String strValue, String errorMessage)
			throws Exception {
	...
	public void verifyTextIsNotDisplayed(String elementName, String locatorStrategy, String errorMessage)
			throws Exception {
	...
	public int enterNumbers(String elementName, String locatorStrategy, String keys, int numberOfRandomNumbers) throws Exception{
		waitForElementIsVisible(elementName, locatorStrategy);
		getElement(elementName, locatorStrategy).clear();
		getElement(elementName, locatorStrategy).sendKeys(keys+RandomStringUtils.randomNumeric(numberOfRandomNumbers));
	...
	public String verifyGetText(String elementName, String locatorStrategy,String expectedText) throws Exception {
		String text = getElement(elementName, locatorStrategy).getText();
		logger.info("Comparing elementText : '"+text +"' equals to expectedText : '"+expectedText+"' in element "+elementName);
